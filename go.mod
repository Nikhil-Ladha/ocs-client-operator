...
replace (
	...
	github.com/red-hat-storage/ocs-operator/services/provider/api/v4 => github.com/nikhil-ladha/ocs-operator/services/provider/api/v4 v4.0.0-20250917095253-cf05c428eef0
